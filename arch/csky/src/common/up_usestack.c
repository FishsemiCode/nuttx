/************************************************************************************
 *arch/csky/src/common/up_usestack.c
 *
...
/* csky requires at least a 4-byte stack alignment.  For use with EABI and
...
int up_use_stack(struct tcb_s *tcb, void *stack, size_t stack_size)
{
  ...
  /* The csky stack must be aligned; 4 byte alignment for OABI and 8-byte
